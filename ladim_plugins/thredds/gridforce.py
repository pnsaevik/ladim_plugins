...
class OnlineDatabase:
    DEFAULT_URL = "https://thredds.met.no/thredds/dodsC/fou-hi/new_norkyst800m/his/ocean_his.an.{year:04}{month:02}{day:02}.nc"

    def __init__(self, pattern=None):
        self._dset_buf = Buffer()
        self._vars_buf = Buffer()
        self.pattern = pattern or self.DEFAULT_URL
